...
tf.app.flags.DEFINE_string("train_dir_optimal", "/tmp_optimal", "Training directory optimal.")
...
def create_model(session, forward_only):
  ...
  model = seq2seq_model.Seq2SeqModel(
      ...
      dtype=dtype)
  ckpt = tf.train.get_checkpoint_state(FLAGS.train_dir_optimal)
